	...
	<body>
		<div class= "hheader">
			...
			<div class="col-12" id="navBar">
				<a href="yourprofile.jsp" id="goButton">Profile</a>
		...
		<div id="products">
			...
			<div class = "container">
				<h1>My Profile</h1>
                <h2>Seller from New Brunswick, New Jersey</h2>
                <hr>
                <div class ="row">
                    <div class = "col-9">
                        <div class = "desc_row">
                            <h3 id = "desc_itemPrice">My Listings</h3>
                            <button id = "desc_bidButton" class = "hvr-bob actionButton">Add Listing +</button>
                        </div>
                        <br>
                        <div class="container" >
                            <div class="row">
